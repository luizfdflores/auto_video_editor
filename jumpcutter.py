...
def copy_frame(inputframe, outputframe):
...
def input_output_filename(filename):
...
def create_path(s):
    ...
    try:
        ...
        assert False, "Creation of the directory %s failed. (The TEMP folder may already exist." \
                      " Delete or rename it, and try again.)"
...
maxAudioVolume = get_max_volum(audioData)
...
for i in range(audioFrameCount):
    ...
    maxchunksVolume = float(get_max_volum(audiochunks)) / maxAudioVolume
